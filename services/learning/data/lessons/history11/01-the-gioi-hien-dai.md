# Thế giới hiện đại - Lịch sử 11

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Thế giới hiện đại" trong chương trình Lịch sử lớp 11.
...
Thế giới hiện đại là một phần quan trọng trong mạch kiến thức Lịch sử. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Thế giới hiện đại".

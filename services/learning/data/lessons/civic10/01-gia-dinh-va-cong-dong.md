# Gia đình và cộng đồng - Giáo dục công dân 10

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Gia đình và cộng đồng" trong chương trình Giáo dục công dân lớp 10.
...
Gia đình và cộng đồng là một phần quan trọng trong mạch kiến thức Giáo dục công dân. Ở lớp 10, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Gia đình và cộng đồng".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Gia đình và cộng đồng".

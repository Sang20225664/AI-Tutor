# Thực vật và động vật - Sinh học 12

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Thực vật và động vật" trong chương trình Sinh học lớp 12.
...
Thực vật và động vật là một phần quan trọng trong mạch kiến thức Sinh học. Ở lớp 12, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 2:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Thực vật và động vật".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Thực vật và động vật".

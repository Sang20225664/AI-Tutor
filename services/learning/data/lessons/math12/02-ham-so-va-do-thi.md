# Hàm số và đồ thị - Toán học 12

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Hàm số và đồ thị" trong chương trình Toán học lớp 12.
...
Hàm số và đồ thị là một phần quan trọng trong mạch kiến thức Toán học. Ở lớp 12, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 2:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Hàm số và đồ thị".

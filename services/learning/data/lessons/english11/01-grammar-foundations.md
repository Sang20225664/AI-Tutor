# Grammar foundations - Tiếng Anh 11

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Grammar foundations" trong chương trình Tiếng Anh lớp 11.
...
Grammar foundations là một phần quan trọng trong mạch kiến thức Tiếng Anh. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Grammar foundations".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Grammar foundations".

...
## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Điện học" trong chương trình Vật lý lớp 7.
...
Điện học là một phần quan trọng trong mạch kiến thức Vật lý. Ở lớp 7, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

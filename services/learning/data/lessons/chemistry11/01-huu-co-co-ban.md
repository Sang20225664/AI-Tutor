# Hữu cơ cơ bản - Hóa học 11

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Hữu cơ cơ bản" trong chương trình Hóa học lớp 11.
...
Hữu cơ cơ bản là một phần quan trọng trong mạch kiến thức Hóa học. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Hữu cơ cơ bản".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Hữu cơ cơ bản".

...
## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Nhiệt học" trong chương trình Vật lý lớp 11.
...
Nhiệt học là một phần quan trọng trong mạch kiến thức Vật lý. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 2:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Nhiệt học".

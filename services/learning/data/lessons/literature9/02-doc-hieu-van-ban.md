# Đọc hiểu văn bản - Ngữ văn 9

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Đọc hiểu văn bản" trong chương trình Ngữ văn lớp 9.
...
Đọc hiểu văn bản là một phần quan trọng trong mạch kiến thức Ngữ văn. Ở lớp 9, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

# Từ vựng và câu - Ngữ văn 1

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Từ vựng và câu" trong chương trình Ngữ văn lớp 1.
...
Từ vựng và câu là một phần quan trọng trong mạch kiến thức Ngữ văn. Ở lớp 1, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

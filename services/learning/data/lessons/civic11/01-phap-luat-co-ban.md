# Pháp luật cơ bản - Giáo dục công dân 11

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Pháp luật cơ bản" trong chương trình Giáo dục công dân lớp 11.
...
Pháp luật cơ bản là một phần quan trọng trong mạch kiến thức Giáo dục công dân. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Pháp luật cơ bản".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Pháp luật cơ bản".

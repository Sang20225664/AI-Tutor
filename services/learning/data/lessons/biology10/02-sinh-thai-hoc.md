# Sinh thái học - Sinh học 10

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Sinh thái học" trong chương trình Sinh học lớp 10.
...
Sinh thái học là một phần quan trọng trong mạch kiến thức Sinh học. Ở lớp 10, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 2:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Sinh thái học".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Sinh thái học".

# Lập trình cơ bản - Tin học 3

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Lập trình cơ bản" trong chương trình Tin học lớp 3.
...
Lập trình cơ bản là một phần quan trọng trong mạch kiến thức Tin học. Ở lớp 3, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Lập trình cơ bản".

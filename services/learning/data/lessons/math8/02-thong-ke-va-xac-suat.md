# Thống kê và xác suất - Toán học 8

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Thống kê và xác suất" trong chương trình Toán học lớp 8.
...
Thống kê và xác suất là một phần quan trọng trong mạch kiến thức Toán học. Ở lớp 8, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

# Từ vựng và câu - Ngữ văn 11

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Từ vựng và câu" trong chương trình Ngữ văn lớp 11.
...
Từ vựng và câu là một phần quan trọng trong mạch kiến thức Ngữ văn. Ở lớp 11, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.
...
## 3. Ví dụ minh họa
**Ví dụ 1:** Một câu hỏi yêu cầu xác định nội dung chính của chủ đề "Từ vựng và câu".
...
2. Nêu một ví dụ thực tế liên quan đến chủ đề "Từ vựng và câu".

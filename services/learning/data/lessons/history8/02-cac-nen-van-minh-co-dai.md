# Các nền văn minh cổ đại - Lịch sử 8

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Các nền văn minh cổ đại" trong chương trình Lịch sử lớp 8.
...
Các nền văn minh cổ đại là một phần quan trọng trong mạch kiến thức Lịch sử. Ở lớp 8, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

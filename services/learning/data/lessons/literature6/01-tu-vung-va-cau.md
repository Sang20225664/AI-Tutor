# Từ vựng và câu - Ngữ văn 6

## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Từ vựng và câu" trong chương trình Ngữ văn lớp 6.
...
Từ vựng và câu là một phần quan trọng trong mạch kiến thức Ngữ văn. Ở lớp 6, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

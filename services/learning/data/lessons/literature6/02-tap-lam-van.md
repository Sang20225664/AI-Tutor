...
## Mục tiêu bài học
- Nắm được kiến thức trọng tâm của chủ đề "Tập làm văn" trong chương trình Ngữ văn lớp 6.
...
Tập làm văn là một phần quan trọng trong mạch kiến thức Ngữ văn. Ở lớp 6, học sinh cần hiểu khái niệm cốt lõi, biết liên hệ với các bài đã học trước đó và hình thành cách trình bày lời giải rõ ràng.

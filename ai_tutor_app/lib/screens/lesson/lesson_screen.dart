...
class LessonSuggestionScreen extends StatelessWidget {
  final List<Map<String, String>> lessons = [
    ...
    },
    {
      ...
      'image': 'https://askany.com/_next/image?url=https%3A%2F%2Fd2czqxs5dso3qv.cloudfront.net%2Fimages%2Fd12931ac-597f-4aa4-aa41-6e444b7a2d8e.png&w=1920&q=75',
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              leading: Image.network(lesson['image']!, width: 60, fit: BoxFit.cover),
